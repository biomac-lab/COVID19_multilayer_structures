...
def ventilation_rate_per_person(lenght_room,width_room,heigh_room,ventilation_out,N_people):
    room_volume = lenght_room*width_room*heigh_room     # m3
...
def avg_quanta_concentration(lenght_room,width_room,heigh_room,ventilation_out,
...
def quanta_inhaled_per_person(lenght_room,width_room,heigh_room,ventilation_out,
            inhalation_mask_eff,exhalation_mask_eff,fraction_people_masks,duration_event_h,breathing_rate=BREATHING_RATE):
    avg_quanta_concentration_val = avg_quanta_concentration(lenght_room,width_room,heigh_room,ventilation_out,
                                                            exhalation_mask_eff,fraction_people_masks,duration_event_h)
    return avg_quanta_concentration_val*breathing_rate*duration_event_h*(1-inhalation_mask_eff*fraction_people_masks)


def infection_probability(lenght_room,width_room,heigh_room,ventilation_out,
            inhalation_mask_eff,exhalation_mask_eff,fraction_people_masks,duration_event_h,breathing_rate=BREATHING_RATE):
    quanta_inhaled_per_person_val = quanta_inhaled_per_person(lenght_room,width_room,heigh_room,ventilation_out,
            inhalation_mask_eff,exhalation_mask_eff,fraction_people_masks,duration_event_h,breathing_rate=BREATHING_RATE)
